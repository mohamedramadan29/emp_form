        ...
        <div class="bread">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> مشاهدة جميع التقديرات </li>
                </ol>
            </nav>
        </div>
                ...
                <tbody> <?php
                        ...
                        foreach ($alltype as $type) { ?> <tr>
                            ...
                            <td>
                                ...
                                <a class="confirm btn btn-danger btn-sm" href="main.php?dir=grads&page=delete&id=<?php echo $type['id']; ?> ">
