<div class="container customer_report">
    <div class="data">
        <div class="bread">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> الاعدادت العامة للموقع </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="table-responsive">
            ...
            <table id="" class="table table-light table-striped table-hover table-bordered">
                <thead>
                    <tr>
                        <th> تغير السنة الدراسية </th>
                        <th> </th>
                    </tr>
                </thead>
                <tbody> <?php
                                        ...
                                        <div class="myform">
                                            <form class="form-group insert ajax_form" action="main.php?dir=settings&page=edit" method="POST" autocomplete="on" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="box2">
                                                            <label id="name"> تغير السنة 
                                                                <span> * </span> </label>
                                                            <input required class="form-control" type="text" name="name" value="<?php echo $type['text'] ?>">
                                                        </div>
                                                        <div class="box submit_box">
