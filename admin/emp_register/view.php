                ...
                <div>
                    ...
                    <div class="fieldset-content">
                        ...
                        <div class="form-group">
                            ...
                            <input required type="text" name="emp_nationality" id="emp_nationality" value="<?php echo $emp_data['emp_nationality']; ?>" />
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-flex">
                                <div class="form-group">
                                    ...
                                    <div id="" class="select_date">
                                        <input id="" type="text" name="emp_place_issue_m" value="<?php echo $emp_data['emp_place_issue_m']; ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div id=" " class="select_date">
                                        <input id=" " type="text" name="emp_place_issue_h" value="<?php echo $emp_data['emp_place_issue_h']; ?>" />
                    ...
                    <div class=" fieldset-content">
                        ...
                        <div class="form-group">
                            ...
                            <input required type="text" name="emp_town" id="emp_town" value="<?php echo $emp_data['emp_town'] ?>" />
                        </div>
                        <div class="form-group">
